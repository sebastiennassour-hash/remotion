...
export const photoPosts: PhotoPost[] = [
	...
	{slug: 'Table', photo: '03.png', template: 'full', kicker: '21h14', line: 'Ici, une table ne reste jamais vide longtemps.', caption: 'Ici, une table ne reste jamais vide longtemps.\n\nCe n’est pas une question de chance. C’est ce que les gens voient de vous avant de venir.\n\nVision. Agence vidéo, restaurants, Suisse romande.'},
	...
	{slug: 'Fondue', photo: '12.png', template: 'full', kicker: 'Suisse', line: 'Le fromage file à la troisième seconde. On le sait.', caption: 'Le fromage file à la troisième seconde. On le sait.\n\nUn plat se filme comme un visage : il faut connaître le geste avant de lancer la caméra.\n\nVision. Restaurants uniquement.'},
	...
	{slug: 'Feu', photo: '17.png', template: 'full', kicker: '20h03 · Le passe', line: 'Le coup de feu, filmé à 120 images par seconde.', caption: 'Le coup de feu, filmé à 120 images par seconde.\n\nCe que vos clients adorent et que personne ne filme. Nous, si.\n\nVision.'},
