# Scripts voix off — reels explicatifs Vision (30 à 40 s)

## EXP-01 — La méthode
On filme. Vous cuisinez.
Une matinée dans votre restaurant, avant le service, sans rien changer à votre organisation.
On repart avec un mois de contenu : des vidéos courtes, montées, publiées, suivies.
Vous n’avez rien à apprendre, rien à poster, rien à gérer.
Vision. L’agence vidéo des restaurants suisses.

## EXP-02 — Pourquoi que des restaurants
On ne filme que des restaurants. Et c’est un choix.
Une salle a une heure. Un plat se filme comme un visage. Vos clients ne veulent pas une pub, ils veulent voir la table où ils vont s’asseoir.
Ça ne s’apprend pas en faisant aussi de l’immobilier.
...
Pas par posture : un accompagnement réel demande du temps et de la présence.
Stratégie, tournage, montage, diffusion, un seul interlocuteur.
Si votre ville est libre, on vous le dit en vingt-quatre heures.
Écrivez-nous. Vision.
